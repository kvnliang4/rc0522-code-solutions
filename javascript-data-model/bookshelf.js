...
console.log('The ISBN of Introduction to Javascript Object Notation: A To-the-Point Guide to JSON', bookshelf[0].isbn);
console.log('The title of the book is Phil Sturgeon &amp; Laura Bohill', bookshelf[2].title);
