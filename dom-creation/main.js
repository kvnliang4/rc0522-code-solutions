...
function renderPokemon(pokemon) {
  ...
  outterDiv.appendChild(imageURL);
  imageURL.src = pokemon.imageUrl;
  var innerDiv2 = document.createElement('div');
  innerDiv2.className = 'pokemon-card-text';
  ...
  innerDiv2.appendChild(number);
  var pokemonNumber = document.createTextNode(pokemon.number);
  number.appendChild(pokemonNumber);
  var description = document.createElement('p');
  innerDiv2.appendChild(description);
  var pokemonDescription = document.createTextNode(pokemon.description);
  description.appendChild(pokemonDescription);
  innerDiv.insertBefore(imageURL, innerDiv2);
  return outterDiv;
}
